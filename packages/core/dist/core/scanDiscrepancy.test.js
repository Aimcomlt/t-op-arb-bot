...
describe('scanDiscrepancy', () => {
    ...
    it('returns null when below threshold', () => {
        ...
        expect(scanDiscrepancy(snaps, { thresholdBps: 50, minLiquidity: 50 })).toMatchInlineSnapshot('null');
    });
    it('filters out low liquidity pools', () => {
        ...
        expect(scanDiscrepancy(snaps, { thresholdBps: 50, minLiquidity: 50 })).toBeNull();
    });
