 ...
 */
export declare function debugTraceTransaction(hash: `0x${string}`, opts?: DebugTraceOptions): Promise<unknown>;
/** Optional convenience wrapper mirroring your previous API. */
export declare const debugClient: {
    traceTransaction(hash: `0x${string}`): Promise<unknown>;
};
